...
namespace Ui
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<Services.Locais.ILocaisService, Services.Locais.LocaisService>();

            services.AddScoped<Services.Generic.IGenericService <Models.Agenda.Reserva>, Services.Reservas.ReservasService>();
